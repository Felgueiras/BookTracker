...
import kotlinx.android.synthetic.main.notification_main.*
...
class MainActivity : Activity() {
    ...
    companion object {
        ...
        public val NOTIFICATION_FOLLOW = 1100
    ...
    private fun sendNotification(id: Int) {
        when (id) {
            NOTIFICATION_FOLLOW -> mNotificationHelper.notify(id, mNotificationHelper.getNotificationElapsedTime(
            ...
            NOTIFICATION_UNFOLLOW -> mNotificationHelper.notify(id, mNotificationHelper.getNotificationElapsedTime(
                    getString(R.string.follower_title_notification),
    ...
    internal inner class MainUi : View.OnClickListener {
        ...
        override fun onClick(view: View) {
            when (view.id) {
                ...
                R.id.follower_channel_settings_button -> goToNotificationChannelSettings(NotificationHelper.ELAPSED_TIME_CHANNEL)
